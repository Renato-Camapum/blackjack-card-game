...
def compare(user_score, computer_score):
    ...
    if user_score == computer_score:
        ...
        return "You lose. The dealer has a black jack."
    elif user_score == 0:
        ...
        return "You lose, the dealer has a higher hand."
...
def play_game():
    ...
    print(f"The dealer final hand is {computer_cards} and total score is {computer_score}")
